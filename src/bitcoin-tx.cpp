...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " poutinecoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  poutinecoin-tx [options] <hex-tx> [commands]  Update hex-encoded poutinecoin transaction\n" +
            "or:     poutinecoin-tx [options] -create [commands]   Create hex-encoded poutinecoin transaction\n" +
            "\n";
