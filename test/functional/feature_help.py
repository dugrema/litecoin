...
"""Verify that starting poutinecoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start poutinecoin with -h for help text")
        ...
        self.log.info("Start poutinecoin with -version for version information")
        ...
        self.log.info("Start poutinecoind with -fakearg to make sure it does not start")
